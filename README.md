...
- [x] Integration tests pass: [docs/screenshots/testing/integration-tests-pass.png](docs/screenshots/testing/integration-tests-pass.png)
  - ![Integration Tests Pass](docs/screenshots/testing/integration-tests-pass.png)
- [x] Unit tests - renewable module: [docs/screenshots/testing/unit-test-renewable.jpeg](docs/screenshots/testing/unit-test-renewable.jpeg)
  - ![Unit Test Renewable](docs/screenshots/testing/unit-test-renewable.jpeg)
- [x] Integration tests - renewable module: [docs/screenshots/testing/integration-test-renewable.jpeg](docs/screenshots/testing/integration-test-renewable.jpeg)
  - ![Integration Test Renewable](docs/screenshots/testing/integration-test-renewable.jpeg)

- [x] Unit tests - energy analytics module: [docs/screenshots/testing/unit-tests-energyAnalytics.png](docs/screenshots/testing/unit-tests-energyAnalytics.png)
  - ![Unit Tests Energy Analytics](docs/screenshots/testing/unit-tests-energyAnalytics.png)
- [x] Integration tests - energy analytics module: [docs/screenshots/testing/integration-tests-energyAnalytics.png](docs/screenshots/testing/integration-tests-energyAnalytics.png)
  - ![Integration Tests Energy Analytics](docs/screenshots/testing/integration-tests-energyAnalytics.png)

- [x] Unit tests - device model: [docs/screenshots/testing/unit-test-deviceModel.jpeg](docs/screenshots/testing/unit-test-deviceModel.jpeg)
  - ![Unit Test Device Model](docs/screenshots/testing/unit-test-deviceModel.jpeg)
- [x] Integration tests - device model/routes: [docs/screenshots/testing/integration-test-deviceModel.jpeg](docs/screenshots/testing/integration-test-deviceModel.jpeg)
  - ![Integration Test Device Model](docs/screenshots/testing/integration-test-deviceModel.jpeg)
