...
const DeviceCharts = ({ devices }) => {
    ...
    // Group devices by type and aggregate consumption
    const typeConsumption = {};
    
    devices.forEach(device => {
        const dailyW = device.powerRating * device.expectedDailyUsage;
        const monthlyW = dailyW * 30;
                ...
                <div className="flex items-start">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-blue-600 mt-1">
                            Charts show energy consumption grouped by device type. Data is calculated from device power ratings and daily usage hours. 
